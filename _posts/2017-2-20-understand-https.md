...
![]({{ site.baseurl }}/assets/images/2017-2-20-292372-b93c4670333eb8d9.png)
...
![对称加密算法]({{ site.baseurl }}/assets/images/2017-2-20-292372-9d943956300560f2.png)
...
![Web服务器使用对称加密算法]({{ site.baseurl }}/assets/images/2017-2-20-292372-528782117a69a5dc.png)

如果服务器端对所有的客户端通信都使用同样的对称加密算法，无异于没有加密。那怎么办呢？**即能使用对称加密算法，又不公开密钥？**请读者思考21秒钟。😜

答案是：Web服务器与每个客户端使用不同的对称加密算法：

![Web服务器与每个客户端使用不同对称加密算法]({{ site.baseurl }}/assets/images/2017-2-20-292372-d38dbcf3633a1cc9.png)
...
![协商对称加密算法]({{ site.baseurl }}/assets/images/2017-2-20-292372-88ce3bd16ac6006d.png)
...
![非对称加密]({{ site.baseurl }}/assets/images/2017-2-20-292372-ae678fa7d569dac9.png)
...
![中间人将公钥拦截了]({{ site.baseurl }}/assets/images/2017-2-20-292372-8f0d8228af2f6480.png)
...
![第一版数字证书的内容]({{ site.baseurl }}/assets/images/2017-2-20-292372-f3dd4b7370df950e.png)

如果能解密，就说明这个公钥没有被中间人调包。因为如果中间人使用自己的私钥加密后的东西传给客户端，客户端是无法使用第三方的公钥进行解密的。

![开始引入第三方机构]({{ site.baseurl }}/assets/images/2017-2-20-292372-3b7c21b3525c0e64.png)
...
第三方机构向多家公司颁发证书的情况：
![第三方机构向多家公司颁发证书的情况]({{ site.baseurl }}/assets/images/2017-2-20-292372-66e00dc26cea3112.png)


客户端能解密同一家第三机构颁发的所有证书：
![客户端能解密同一家第三机构颁发的所有证书]({{ site.baseurl }}/assets/images/2017-2-20-292372-5bf2c898914e749f.png)

最终导致其它持有同一家第三方机构证书的中间人可以进行调包：

![证书依然可以被中间人调包]({{ site.baseurl }}/assets/images/2017-2-20-292372-b2bd3805bc25fd2c.png)
...
![]({{ site.baseurl }}/assets/images/2017-2-20-292372-ac2b0d452a4e8b05.png)
...
![]({{ site.baseurl }}/assets/images/2017-2-20-292372-60fd73c3f79e8641.png)

当客户端拿到证书后，开始对证书中的内容进行验证，如果客户端计算出来的证书编号与证书中的证书编号相同，则验证通过：

![]({{ site.baseurl }}/assets/images/2017-2-20-292372-4dbf41053fb6fb25.png)
...
![申请数字证书]({{ site.baseurl }}/assets/images/2017-2-20-292372-6eb448d41e6bc2fb.png)
...
![TLS协议]({{ site.baseurl }}/assets/images/2017-2-20-292372-323411d0bb2d7232.png)
